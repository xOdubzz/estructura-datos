...
#perfilado del algoritmo insertion sort
print("Ordenado por: INSERTION SORT")
cProfile.run('insertion_sort(numeros_aleatorios)', sort = 'cumulative')



#perfilado del algoritmo quicksort
print("Ordenado por: QUICK SORT")
cProfile.run('quicksort(numeros_aleatorios)', sort = 'cumulative')



#perfilado del algoritmo bubble sort
print("Ordenado por: BUBBLE SORT")
